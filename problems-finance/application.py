...
def register():
    ...
    if request.method == "POST":
        ...
        hash_password = pwd_context.encrypt(request.form.get("password1"))
        
        result = db.execute("INSERT INTO users (username, hash) values (:username, :hash)", username=request.form.get("username"), hash=hash_password)
